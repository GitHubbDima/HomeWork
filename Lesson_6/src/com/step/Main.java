...
/*
        ...
        initArray.setNumbers(demoArray);*/

/*        ArraySum arraySum = new ArraySum();
        System.out.println(" the sum array is : " + arraySum.calculateSumArray(demoArray));*/

/*        ReversArray reversArray = new ReversArray();
        reversArray.showReversArray(demoArray);*/

/*        ArrayMax arrayMax = new ArrayMax();
        System.out.println(" the max value is: " + arrayMax.findMaxNumberArray(demoArray));
        System.out.println(" the min value is: " + arrayMax.findMinNumberArray(demoArray));*/

/*        char[] character = new char[3];
        initArray.setCharacter(character);

        FindInt findInt = new FindInt();
        findInt.showConsonantVowel(character);*/
